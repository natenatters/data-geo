...
export const MANCHESTER_EVENTS: HistoricalEvent[] = [
  ...
  { year: 536, label: 'Volcanic winter — crops fail, famine', short: 'Dark sun' },
  { year: 616, label: 'Æthelfrith marches to Chester (via Manchester?)', short: 'Chester battle' },
  { year: 664, label: 'Great Plague ravages Northumbria', short: 'Plague' },
  { year: 793, label: 'Vikings raid Lindisfarne', short: 'Vikings' },
  { year: 902, label: 'Norse expelled from Dublin, settle Lancashire', short: 'Norse arrive' },
